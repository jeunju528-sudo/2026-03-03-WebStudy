...
body {
  ...
  margin: 20px; /* 20px(top) 20px(right) 20px(bottom) 20px(left) */
}
h2{
   margin-top: 40px;
...
<body>
  ...
  <p class="exam" style="text-alignt: center;"><%=sort[1] %></p>
  ...
  ***<p class="exam" style="text-decoration: line-through ;"><%=line[3] %></p>
  ...
  <%
     ...
     /*
            ...
            while-space:pre-wrap => 크기에 따라 자동 줄바꿈 
                => 상세보기 (줄거리 => pre)
     */
  %>
  <h2><%=h2 %></h2>
